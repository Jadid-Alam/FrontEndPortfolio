...
import portfolioImage from '../images/photos/portfolioImage.PNG';
import invoiceGif from '../images/photos/InoviceBuilderProjectGif.gif';
import horseGif from '../images/photos/HorseRacingGif.gif';
import hwPortal from '../images/photos/hwPortalGif.gif';
import rustImg from '../images/icons/rust.svg';
import javaImg from '../images/icons/java.svg';
import javascriptImg from '../images/icons/javascript.svg';
import reactImg from '../images/icons/react.svg';
import awsImg from '../images/icons/aws.svg';
import htmlImg from '../images/icons/html.svg';
import cssImg from '../images/icons/css.svg';
import phpImg from '../images/icons/php.svg';
import djangoImg from '../images/icons/django.svg';
import mysqlImg from '../images/icons/mysql.svg';
import pythonImg from '../images/icons/python.png';
import fdmImg from '../images/photos/fdm-expense-app.png';
import awsImgProj from '../images/icons/aws.png';
import cplusplusImg from '../images/icons/c++.png';
import tradingAiForgeImg from '../images/photos/TradingAiForgeImg.png';
...
const projectsData = [
  {
    ...
    description: "TradingAIForge is a collaborative group project I'm currently developing that enables users to build personalized trading bots based on their unique trading styles. The goal is to deliver an intuitive experience focused on ease of customization, with a target of achieving over 80% positive user feedback.",
  ...
  },
  {
    ...
    description: 'Developed a custom homework management system for students and teachers of LSC (London Science College) using CSS, PHP on WordPress and Wix.',
